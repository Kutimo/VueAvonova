...
<template>
  <div
    class="m-10 h-[150px] w-[500px] p-12 flex justify-center p- overflow-hidden rounded-lg shadow-md transform transition-transform duration-300 hover:scale-105"
  >
