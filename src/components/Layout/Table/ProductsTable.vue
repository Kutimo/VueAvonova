<template>
  <div class="container mx-auto px-4 py-6">
    <div class="relative mb-4">
      <input type="text" v-model="searchQuery" placeholder="Søk blant alle produkter..."
    ...
    <table class="w-full border-collapse bg-white shadow-md text-lg">
      <thead>
        <tr>
          ...
          <th class="p-3 border-b border-gray-200 bg-gray-50 text-left font-semibold text-gray-600">
            Handlinger
          </th>
        </tr>
      </thead>
      <tbody>
        <tr v-for="item in filteredData" :key="item.id" class="hover:bg-gray-50 border-b border-gray-300">
          <td v-for="header in headers" :key="header.key" class="p-3 border-t border-gray-300 text-gray-700"
          ...
          <td class="p-3 border-t border-gray-300 text-gray-700">
            <details class="group">
              ...
              <div class="mt-4">
                ...
                <p class="text-green-1200 mt-2 cursor-pointer hover:text-green-600 underline" @click="orderProduct">
                  Bestill nå
                </p>
              </div>
            </details>
